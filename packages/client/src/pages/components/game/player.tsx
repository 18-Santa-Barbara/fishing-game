import warrior from '../../../assets/game/warrior.png'
import warriorLeft from '../../../assets/game/warrior-left.png'

import warriorRun from '../../../assets/game/warrior-run.png'
import warriorRunLeft from '../../../assets/game/warrior-run-left.png'

import warriorFight from '../../../assets/game/warrior-fight.png'
import warriorFightLeft from '../../../assets/game/warrior-fight-left.png'
...
export class MainPlayer {
    ...
    sprites: { stand: { right: HTMLImageElement; left: HTMLImageElement }; 
    ...
    draw(context: any) {
        if (!this.doAttack) {
            context.drawImage(this.current, 69 * Math.round(this.frames), 0, 69, 35, this.position.x, this.position.y, this.width, this.height)
        } else {
            if (this.current == this.sprites.fight.right) {
                context.drawImage(this.current, 69 * Math.round(this.frames), 0, 69, 45, this.position.x, this.position.y, this.width + 40, this.height)
            } else {
                context.drawImage(this.current, 138 * Math.round(this.frames), 0, 69, 45, this.position.x, this.position.y, this.width + 20, this.height)
            }
        }
    }
