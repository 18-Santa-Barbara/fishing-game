import enemyFallsLeft from '../../../assets/game/enemy-falls-left.png'
import enemyFalls from '../../../assets/game/enemy-falls.png'
...
export class Enemy {
    ...
    draw(context: any) {
        context.drawImage(this.current, 64 * Math.round(this.frames), 0, 61, 42, this.position.x, this.position.y, this.width, this.height)
    }
