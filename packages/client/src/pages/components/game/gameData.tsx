...
export function getGameData() {
  ...
  // платформы
  const platforms = [new Platform(-1, 550, defaultPlatform), 
  ...
  // алмазы
  const coins = [new Coin(350, 470, coin),
  ...
  // фон
  const backgroundPlatform = [new PlatformBackground(-1, -1, platformBack), 
                              new PlatformBackground(1024 - 1, -1, platformBack)]
  const backgroundCastle = [new PlatformBackground(-1, 160, castleBack), 
  ...
  // враг
  const skeletons = [new Enemy(2185, 470, enemy),
